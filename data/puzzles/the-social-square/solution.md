As hinted by the flavortext and video,
one needs to find the social media profiles of the three speakers
in the video and extract a message hinted by the video.
...
Taken `B`, `RAVEL` and `Y` together gives the answer `BRAVELY`{.answer}.
